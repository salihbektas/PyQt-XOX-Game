...
class Game(QtWidgets.QMainWindow):
    ...
    def pressReset(self):
        ...
        self.ui.toolButton_1.setStyleSheet("background-color:white")
        self.ui.toolButton_2.setStyleSheet("background-color:white")
        self.ui.toolButton_3.setStyleSheet("background-color:white")
        self.ui.toolButton_4.setStyleSheet("background-color:white")
        self.ui.toolButton_5.setStyleSheet("background-color:white")
        self.ui.toolButton_6.setStyleSheet("background-color:white")
        self.ui.toolButton_7.setStyleSheet("background-color:white")
        self.ui.toolButton_8.setStyleSheet("background-color:white")
        self.ui.toolButton_9.setStyleSheet("background-color:white")
